...
RESUME_LATEST=true bash tools/dist_train.sh configs/mini_imagenet/resnet12_etf_bs512_500e_miniimagenet_mambafscil.py $GPUS --work-dir ${work_dir} --seed 0 --deterministic
